...
function App() {
  ...
  let items  = [
    {image:<img src={deezer} width={130} ></img>, lien: "https://www.deezer.com/fr/artist/156679512?app_id=140685"},
    {image:<img src={spotify} width={130} ></img>, lien: "https://open.spotify.com/artist/3e5xVQwYPv4xHzwrjKaVPv?si=hSPN5ZcqTOir1B0HURQu4w"},
    {image:<AppleMusic />, lien: "https://music.apple.com/fr/artist/michel-hubert/1602819524"},
    {image:<img src={youtube} width={120} ></img>, lien: "https://www.youtube.com/channel/UCqa8GQLCMGoUmX4T4UFPAmQ"},
  ]

  let link = "https://www.youtube.com/channel/UCqa8GQLCMGoUmX4T4UFPAmQ";
  return (
...
et articulé autour d’une scénographie sensationnelle.
          ...
          <div className='container bg-white/10 rounded-xl my-8 p-5 grid grid-cols-2 grid-rows-2'>
              {
                items.map( (value, index) =>
                <>
                <a  className='flex items-center justify-center p-3 h-[60px]  rounded-lg hover:bg-white/10' 
                    href={value.lien}
                    target="_blank"
                    key={index}
                    >
          ...
          <footer className="text-center m-4 text-gray-200 opacity-60">Michel Hubert © 2022 - created by <a href="https://www.antoinebarbier.fr" target="_blank" className="font-medium hover:text-white ">@An_toine</a> </footer>
        </div>
    </div>
  );
}
